...
.PHONY: help z1-up z1-build z1-down z1-stop z1-logs z1-clean z1-ps z2-up z2-down z2-clean z2-bootstrap z3-build z3-down z3-logs
...
z3-logs:
	docker compose -f $(COMPOSE_Z3) logs -f
